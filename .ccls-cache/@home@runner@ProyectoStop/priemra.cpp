...
int main() {
  ...
  if (pre1 == "si") {
    ...
    cout << "------------------------------------------------------------------"
            "------------------------ \n";
    cout << "letra     Nombre     Apellido       Animal       Fruta        País     Color    Cosa    Puntaje  \n";
    cout << "------------------------------------------------------------------"
            "-------------------------\n";
     cout << letra<<espaciar(5);
    for (int i =0; i<=6;i++){
    cout <<   espaciar( 5) << espaciar(5);
      }
    cout <<espaciar(5)<< puntaje;
